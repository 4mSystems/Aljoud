...
public class FragmentLessonArticlesBindingImpl extends FragmentLessonArticlesBinding  {
    ...
    public FragmentLessonArticlesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FragmentLessonArticlesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    private boolean onChangeViewmodel(te.app.aljoud.pages.courseDetails.viewModels.LessonDetailsViewModel Viewmodel, int fieldId) {
        ...
        else if (fieldId == BR.articlesAdapter) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
            return true;
    ...
    protected void executeBindings() {
        ...
        te.app.aljoud.pages.courseDetails.adapters.LessonArticlesAdapter viewmodelArticlesAdapter = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xbL) != 0) {
                    ...
                    if (viewmodel != null) {
                        // read viewmodel.articlesAdapter
                        viewmodelArticlesAdapter = viewmodel.getArticlesAdapter();
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0xbL) != 0) {
            ...
            te.app.aljoud.base.ApplicationBinding.getItemsV2Binding(this.rcArticles, viewmodelArticlesAdapter, "1", "1");
        }
    }
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): viewmodel.articlesAdapter
