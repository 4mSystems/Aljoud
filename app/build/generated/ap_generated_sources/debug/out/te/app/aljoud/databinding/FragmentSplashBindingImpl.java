...
public class FragmentSplashBindingImpl extends FragmentSplashBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.aljoud.pages.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.aljoud.pages.splash.SplashViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((te.app.aljoud.pages.splash.SplashViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(te.app.aljoud.pages.splash.SplashViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
