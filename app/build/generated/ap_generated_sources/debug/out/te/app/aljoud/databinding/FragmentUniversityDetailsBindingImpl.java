...
public class FragmentUniversityDetailsBindingImpl extends FragmentUniversityDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.card_info, 2);
        sViewsWithIds.put(R.id.tv_special, 3);
        sViewsWithIds.put(R.id.tv_subjects, 4);
        sViewsWithIds.put(R.id.tv_lessons, 5);
        sViewsWithIds.put(R.id.tv_students, 6);
        sViewsWithIds.put(R.id.ic_university, 7);
    }
    // views
    @NonNull
