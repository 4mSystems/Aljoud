...
public class ReplySheetBindingImpl extends ReplySheetBinding implements te.app.aljoud.generated.callback.OnClickListener.Listener {
    ...
    public ReplySheetBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ReplySheetBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, viewModelRequestMessage);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): viewModel.filesAdapter
        flag 2 (0x3L): null
    flag mapping end*/
    //end
}