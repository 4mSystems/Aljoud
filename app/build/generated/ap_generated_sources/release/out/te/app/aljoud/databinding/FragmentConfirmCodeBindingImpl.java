...
public class FragmentConfirmCodeBindingImpl extends FragmentConfirmCodeBinding implements te.app.aljoud.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_verify_phone, 6);
        sViewsWithIds.put(R.id.ic_verify, 7);
    ...
    private androidx.databinding.InverseBindingListener pinValidateandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewmodel.request
            te.app.aljoud.pages.auth.models.ConfirmCodeRequest viewmodelRequest = null;
            // viewmodel.request.code
            java.lang.String viewmodelRequestCode = null;
            // viewmodel
            te.app.aljoud.pages.auth.confirmCode.ConfirmViewModel viewmodel = mViewmodel;
    ...
    private FragmentConfirmCodeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback62 = new te.app.aljoud.generated.callback.OnClickListener(this, 3);
        mCallback60 = new te.app.aljoud.generated.callback.OnClickListener(this, 1);
        mCallback61 = new te.app.aljoud.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.aljoud.pages.auth.confirmCode.ConfirmViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.aljoud.pages.auth.confirmCode.ConfirmViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((te.app.aljoud.pages.auth.confirmCode.ConfirmViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(te.app.aljoud.pages.auth.confirmCode.ConfirmViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.tvLoginForget.setOnClickListener(mCallback61);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
