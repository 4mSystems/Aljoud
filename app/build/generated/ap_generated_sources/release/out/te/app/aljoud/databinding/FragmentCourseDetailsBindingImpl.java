...
public class FragmentCourseDetailsBindingImpl extends FragmentCourseDetailsBinding implements te.app.aljoud.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewmodelCourseDiscountEqualsJavaLangString000ViewmodelCoursePriceConcatJavaLangStringConcatViewmodelCourseCurrencyCodeViewmodelCourseDiscountConcatJavaLangStringConcatViewmodelCourseCurrencyCode = null;
        ...
        int viewmodelCourseDiscountEqualsJavaLangString000ViewVISIBLEViewGONE = 0;
        ...
        boolean viewmodelCourseDiscountEqualsJavaLangString000 = false;
        java.lang.String viewmodelCourseCountArticlesConcatJavaLangString = null;
        boolean ViewmodelCourseDiscountEqualsJavaLangString0001 = false;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            if((dirtyFlags & 0x7L) != 0) {
                ...
                if (viewmodelCourseDiscount != null) {
                    // read viewmodel.course.discount.equals("0.00")
                    viewmodelCourseDiscountEqualsJavaLangString000 = viewmodelCourseDiscount.equals("0.00");
                }
            if((dirtyFlags & 0x7L) != 0) {
                if(viewmodelCourseDiscountEqualsJavaLangString000) {
                        dirtyFlags |= 0x10L;
                }
                else {
                        dirtyFlags |= 0x8L;
                ...
                // read !viewmodel.course.discount.equals("0.00")
                ViewmodelCourseDiscountEqualsJavaLangString0001 = !viewmodelCourseDiscountEqualsJavaLangString000;
            if((dirtyFlags & 0x7L) != 0) {
            ...
            if((dirtyFlags & 0x7L) != 0) {
                if(ViewmodelCourseDiscountEqualsJavaLangString0001) {
                        dirtyFlags |= 0x100L;
                }
                else {
                        dirtyFlags |= 0x80L;
                ...
                // read !viewmodel.course.discount.equals("0.00") ? View.VISIBLE : View.GONE
                viewmodelCourseDiscountEqualsJavaLangString000ViewVISIBLEViewGONE = ((ViewmodelCourseDiscountEqualsJavaLangString0001) ? (android.view.View.VISIBLE) : (android.view.View.GONE));
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                // read viewmodel.course.discount.equals("0.00") ? viewmodel.course.price.concat(" ").concat(viewmodel.course.currency.code) : viewmodel.course.discount.concat(" ").concat(viewmodel.course.currency.code)
                viewmodelCourseDiscountEqualsJavaLangString000ViewmodelCoursePriceConcatJavaLangStringConcatViewmodelCourseCurrencyCodeViewmodelCourseDiscountConcatJavaLangStringConcatViewmodelCourseCurrencyCode = ((viewmodelCourseDiscountEqualsJavaLangString000) ? (viewmodelCoursePriceConcatJavaLangStringConcatViewmodelCourseCurrencyCode) : (viewmodelCourseDiscountConcatJavaLangStringConcatViewmodelCourseCurrencyCode));
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvNewPrice, viewmodelCourseDiscountEqualsJavaLangString000ViewmodelCoursePriceConcatJavaLangStringConcatViewmodelCourseCurrencyCodeViewmodelCourseDiscountConcatJavaLangStringConcatViewmodelCourseCurrencyCode);
            ...
            this.tvOldPrice.setVisibility(viewmodelCourseDiscountEqualsJavaLangString000ViewVISIBLEViewGONE);
    ...
    /* flag mapping
        ...
        flag 2 (0x3L): null
        flag 3 (0x4L): viewmodel.course.discount.equals("0.00") ? viewmodel.course.price.concat(" ").concat(viewmodel.course.currency.code) : viewmodel.course.discount.concat(" ").concat(viewmodel.course.currency.code)
        flag 4 (0x5L): viewmodel.course.discount.equals("0.00") ? viewmodel.course.price.concat(" ").concat(viewmodel.course.currency.code) : viewmodel.course.discount.concat(" ").concat(viewmodel.course.currency.code)
        ...
        flag 7 (0x8L): !viewmodel.course.discount.equals("0.00") ? View.VISIBLE : View.GONE
        flag 8 (0x9L): !viewmodel.course.discount.equals("0.00") ? View.VISIBLE : View.GONE
