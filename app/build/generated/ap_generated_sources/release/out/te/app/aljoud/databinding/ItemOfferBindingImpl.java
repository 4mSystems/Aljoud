...
public class ItemOfferBindingImpl extends ItemOfferBinding implements te.app.aljoud.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String itemViewModelOfferItemLevelCollegeDataName = null;
        java.lang.String itemViewModelOfferItemDesc = null;
        java.lang.String itemViewModelOfferItemLevelCollegeDataUniversityName = null;
        te.app.aljoud.pages.home.models.home.University itemViewModelOfferItemLevelCollegeDataUniversity = null;
        te.app.aljoud.pages.university.adapters.CourseOffersAdapter itemViewModelCourseAdapter = null;
        ...
        te.app.aljoud.pages.university.models.levels.LevelsData itemViewModelOfferItemLevel = null;
        java.lang.String itemViewModelOfferItemLevelName = null;
        java.lang.String itemViewModelOfferItemPrice = null;
        te.app.aljoud.pages.university.models.levels.CollageData itemViewModelOfferItemLevelCollegeData = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xdL) != 0) {
                    ...
                    if (itemViewModel != null) {
                        // read itemViewModel.courseAdapter
                        itemViewModelCourseAdapter = itemViewModel.getCourseAdapter();
                    }
            }
            if ((dirtyFlags & 0xbL) != 0) {
                    ...
                    if (itemViewModelOfferItem != null) {
                        ...
                        // read itemViewModel.offerItem.level
                        itemViewModelOfferItemLevel = itemViewModelOfferItem.getLevel();
                    ...
                    if (itemViewModelOfferItemLevel != null) {
                        // read itemViewModel.offerItem.level.name
                        itemViewModelOfferItemLevelName = itemViewModelOfferItemLevel.getName();
                        // read itemViewModel.offerItem.level.college_data
                        itemViewModelOfferItemLevelCollegeData = itemViewModelOfferItemLevel.getCollege_data();
                    }
                    ...
                    if (itemViewModelOfferItemLevelCollegeData != null) {
                        // read itemViewModel.offerItem.level.college_data.name
                        itemViewModelOfferItemLevelCollegeDataName = itemViewModelOfferItemLevelCollegeData.getName();
                        // read itemViewModel.offerItem.level.college_data.university
                        itemViewModelOfferItemLevelCollegeDataUniversity = itemViewModelOfferItemLevelCollegeData.getUniversity();
                    }
                    ...
                    if (itemViewModelOfferItemLevelCollegeDataUniversity != null) {
                        // read itemViewModel.offerItem.level.college_data.university.name
                        itemViewModelOfferItemLevelCollegeDataUniversityName = itemViewModelOfferItemLevelCollegeDataUniversity.getName();
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            te.app.aljoud.base.ApplicationBinding.getItemsV2Binding(this.rcLevels, itemViewModelCourseAdapter, "1", "2");
        }
        if ((dirtyFlags & 0xbL) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvDesc, itemViewModelOfferItemDesc);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvLevel, itemViewModelOfferItemLevelName);
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvSpecial, itemViewModelOfferItemLevelCollegeDataName);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvUniversity, itemViewModelOfferItemLevelCollegeDataUniversityName);
        }
    }
    ...
    /* flag mapping
        ...
        flag 2 (0x3L): itemViewModel.courseAdapter
        flag 3 (0x4L): null
    flag mapping end*/
    //end
}